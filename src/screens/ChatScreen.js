    ...
    return ( <
        ...
        { /* Conversations List */ } {
            loading ? ( <
                ...
                FlatList data = { filteredConversations }
                ...
                color = "#ccc" / >
                <
                Text style = { styles.placeholderTitle } > { searchText ? 'No Results' : 'No Conversations Yet' } <
                /Text> <
